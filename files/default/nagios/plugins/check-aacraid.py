...
for line in subprocess.Popen(["/usr/StorMan/arcconf", "GETCONFIG", "1", "LD"], stdout=subprocess.PIPE).communicate()[0].split('\n'):
	# Match the regexs
...
for line in subprocess.Popen(["/usr/StorMan/arcconf", "GETCONFIG", "1", "AD"], stdout=subprocess.PIPE).communicate()[0].split('\n'):
	# Match the regexs
